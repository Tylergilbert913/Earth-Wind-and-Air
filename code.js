...
function showWeather(response) {
    ...
    //     var wind = $("<p>").addClass("card-text").text("Wind speed is: " + data.wind.speed + " MPH");
    //     var humidity = $("<p>").addClass("card-text").text("The humidity is: " + data.main.humidity + " %");
    //     var temp = $("<p>").addClass("card-text").text("The temperature is: " + data.main.temp);
